...
测试：
```
xl@xl-Lenovo-IdeaPad-Y471A:~/桌面/homework/spoc$ python schedule.py -p FIFO
ARG policy FIFO
ARG jobs 3
ARG maxlen 10
ARG seed 0
...
xl@xl-Lenovo-IdeaPad-Y471A:~/桌面/homework/spoc$ python schedule.py -p SJF
ARG policy SJF
ARG jobs 3
ARG maxlen 10
ARG seed 0
...
xl@xl-Lenovo-IdeaPad-Y471A:~/桌面/homework/spoc$ python schedule.py -p RR
ARG policy RR
ARG jobs 3
ARG maxlen 10
ARG seed 0
